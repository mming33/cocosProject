...
export class GetServerData {
    ...
    static UserAvatar = "";
    static UserHeadImage: SpriteFrame = null;
    static UserMoney: number = 0;

    static OtherId = -1;
    static OtherName = "player2";
    static OtherAvatar = "";
    static OtherHeadImage: SpriteFrame = null;
     ...
     * @param err 获取失败
     */
    public static getUserinfo(success: Function = null, err: Function = null): void {
     ...
     * @param err 获取失败
     */
    public static GetCoin(success: Function = null, err: Function = null): void {
        MKMessageManager.httpResult('get', GetServerData.ASSETS, {}, (data) => {
     ...
     * @param err 获取失败
     */
    public static join(success: Function = null, err: Function = null): void {
        MKMessageManager.httpResult('post', GetServerData.JOIN, {}, (data) => {
            if (data && data.id) {
    ...
    public static LeaveGame(): void {
        MKMessageManager.httpResult('post', GetServerData.LEAVE, {}, (data) => {
            console.log(data);
