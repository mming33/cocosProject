...
//消息处理类
export default class MKEventDispatch {
        //界面类型;
        ...
        public static eventType = MKEventDispatch.nowShowLayer.NONE;
        list ={};
        //注册消息
        on(key:any,func:any,node:any) {
        ...
        public static singleton:MKEventDispatch;
        public static get I(): MKEventDispatch{
            if(!this.singleton){
