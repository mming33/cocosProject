...
export default class MKMessageManager {
    ...
    //显示表情;
    public static showEmoji(pos: any, size: any, msg: any) {
    ...
    */
    public static async httpResult(method: any, url: any, sendData = {}, callback: any, number = 2) {
    ...
    public static async httpUserResult(method: any, url: any, sendData = {}, callback: any) {
        let sendUrl = `${this.NET_USER_CONST_PATH}${url}`;
        let result = await NDB.request(method, sendUrl, sendData);
        callback && callback(result);
    }

    public static async httpTestUserResult(method: any, url: any, sendData = {}, callback: any) {
        let sendUrl = url;
        let result = await NDB.request(method, sendUrl, sendData);
        callback && callback(result);
    }

    public static async httpAPIResult(method: any, url: any, sendData = {}, callback: any) {
    ...
    public static async httpIAPResult(method: any, url: any, sendData = {}, callback: any) {
    ...
    */
    public static socketSend(messageType: any, sendData = {}) {
